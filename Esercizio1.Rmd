...
So we have shown that increases implicitly the j-th coordinate of x^(k−2)^by 1 to get x^(k-1)^ correspondsto an explicit change to obtain y^(k)^ is to add the j-th column of L to y^(k−1)^.
...
n <- c(10^4, 10^4, 10^3)
eps <- c(0.1, 0.075, 0.2)
p <- round(c(round(log(n[1])/eps[1]^2), round(log(100)/eps[2]^2), round(log(50)/eps[3]^2)))
